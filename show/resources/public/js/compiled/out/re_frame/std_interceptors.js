...
var vec__50117_50120 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_50121 = cljs.core.nth.call(null,vec__50117_50120,(0),null);
var only_after_50122 = cljs.core.nth.call(null,vec__50117_50120,(1),null);
var db_changed_QMARK__50123 = (cljs.core.some_QMARK_.call(null,only_before_50121)) || (cljs.core.some_QMARK_.call(null,only_after_50122));
if(db_changed_QMARK__50123){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_50121);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_50122);
...
var map__50130 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__50130__$1 = ((((!((map__50130 == null)))?((((map__50130.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50130.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50130):map__50130);
var db = cljs.core.get.call(null,map__50130__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__50130__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__50138 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__50138__$1;
var event = cljs.core.get.call(null,map__50138__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__48849__auto___50141 = arguments.length;
var i__48850__auto___50142 = (0);
while(true){
if((i__48850__auto___50142 < len__48849__auto___50141)){
args__48856__auto__.push((arguments[i__48850__auto___50142]));

var G__50143 = (i__48850__auto___50142 + (1));
i__48850__auto___50142 = G__50143;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__48857__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq50140){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50140));
});
...
var args__48856__auto__ = [];
var len__48849__auto___50149 = arguments.length;
var i__48850__auto___50150 = (0);
while(true){
if((i__48850__auto___50150 < len__48849__auto___50149)){
args__48856__auto__.push((arguments[i__48850__auto___50150]));

var G__50151 = (i__48850__auto___50150 + (1));
i__48850__auto___50150 = G__50151;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__48857__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__50144_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__50145_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__50145_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq50146){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__50147,G__50148,seq50146__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1509481863503