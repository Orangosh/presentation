...
var G__62634 = devtools.prefs.pref.call(null,v);
v = G__62634;
continue;
} else {
return v;
...
var and__47621__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__47621__auto__){
var and__47621__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__47633__auto__ = (function (){try{if(!((value == null))){
...
}catch (e62647){var e__62339__auto__ = e62647;
return false;
}})();
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
var or__47633__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e62651){var e__62339__auto__ = e62651;
return false;
}})();
...
}catch (e62653){var e__62339__auto__ = e62653;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__47621__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__47621__auto__)){
var and__47621__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__47621__auto____$1){
...
var and__47621__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__47621__auto__)){
...
var or__47633__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
...
var and__47621__auto__ = (function (){var or__47633__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
...
var vec__62658 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__62658,(0),null);
var name = cljs.core.nth.call(null,vec__62658,(1),null);
...
var and__47621__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__47621__auto__)){
...
var or__47633__auto__ = typeof value === 'string';
if(or__47633__auto__){
return or__47633__auto__;
} else {
var or__47633__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__62661_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__62661_SHARP_);
}),template);
});
...
var temp__6751__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__6751__auto__)){
var render_pref = temp__6751__auto__;
if(render_pref === true){
...
//# sourceMappingURL=helpers.js.map?rel=1509481877974