...
var len__48849__auto___62675 = arguments.length;
var i__48850__auto___62676 = (0);
while(true){
if((i__48850__auto___62676 < len__48849__auto___62675)){
args__48856__auto__.push((arguments[i__48850__auto___62676]));

var G__62677 = (i__48850__auto___62676 + (1));
i__48850__auto___62676 = G__62677;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__48857__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq62672){
var G__62673 = cljs.core.first.call(null,seq62672);
var seq62672__$1 = cljs.core.next.call(null,seq62672);
var G__62674 = cljs.core.first.call(null,seq62672__$1);
var seq62672__$2 = cljs.core.next.call(null,seq62672__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__62673,G__62674,seq62672__$2);
});
...
if(cljs.core.truth_((function (){var or__47633__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__48285__auto__,writer__48286__auto__,opt__48287__auto__){
return cljs.core._write.call(null,writer__48286__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__47621__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__47621__auto__){
var or__47633__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__62678_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__62678_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__62687__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__47633__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e62691){var e__62339__auto__ = e62691;
return false;
}})();
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
...
}catch (e62693){var e__62339__auto__ = e62693;
return false;
}}
})())){
...
var _STAR_current_state_STAR_62698 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__62699 = opts;
var map__62699__$1 = ((((!((map__62699 == null)))?((((map__62699.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62699.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62699):map__62699);
var markup_db = cljs.core.get.call(null,map__62699__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_62698;
}});
...
;
var temp__6751__auto___62704 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___62704)){
var managed_print_level_62705 = temp__6751__auto___62704;
var _STAR_print_level_STAR_62703_62706 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_62705;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_62703_62706,managed_print_level_62705,temp__6751__auto___62704,writer,opts,job_fn){
return (function (p1__62701_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__62701_SHARP_,null);
});})(_STAR_print_level_STAR_62703_62706,managed_print_level_62705,temp__6751__auto___62704,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_62703_62706;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1509481878141