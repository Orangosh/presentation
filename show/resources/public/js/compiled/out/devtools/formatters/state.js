...
var len__48849__auto___62666 = arguments.length;
var i__48850__auto___62667 = (0);
while(true){
if((i__48850__auto___62667 < len__48849__auto___62666)){
args__48856__auto__.push((arguments[i__48850__auto___62667]));

var G__62668 = (i__48850__auto___62667 + (1));
i__48850__auto___62667 = G__62668;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__48857__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq62664){
var G__62665 = cljs.core.first.call(null,seq62664);
var seq62664__$1 = cljs.core.next.call(null,seq62664);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__62665,seq62664__$1);
});
...
return (function (p1__62669_SHARP_){
return (p1__62669_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1509481878015