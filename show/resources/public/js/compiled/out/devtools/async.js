...
var o__62314__auto___63420 = (function (){var o__62314__auto__ = (function (){var o__62314__auto__ = Promise;
return goog.object.get(o__62314__auto__,"resolve").call(o__62314__auto__);
})();
return goog.object.get(o__62314__auto__,"then").call(o__62314__auto__,callback);
})();
goog.object.get(o__62314__auto___63420,"catch").call(o__62314__auto___63420,devtools.async.rethrow_outside_promise);
...
var G__63422_63423 = Error;
var target__62333__auto___63424 = G__63422_63423;
if(cljs.core.truth_(target__62333__auto___63424)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__63422_63423)].join('')),cljs.core.str("\n"),cljs.core.str("target__62333__auto__")].join('')));
}

goog.object.set(target__62333__auto___63424,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1509481879445