...
var temp__6751__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
...
var reader = (function (){var or__47633__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__47633__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
return (128);
...
var map__63447 = top_item;
var map__63447__$1 = ((((!((map__63447 == null)))?((((map__63447.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63447.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63447):map__63447);
var file = cljs.core.get.call(null,map__63447__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__63447__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__63447__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e63446){var _e = e63446;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___63449 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___63449)){
var seen_errors_63450 = temp__6751__auto___63449;
if(cljs.core.truth_(seen_errors_63450.has(self))){
} else {
seen_errors_63450.add(self);

var temp__6753__auto___63451 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___63451)){
var sense_63452 = temp__6753__auto___63451;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_63452)].join('');
} else {
}
}
} else {
...
var temp__6753__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__6753__auto__)){
var sense = temp__6753__auto__;
...
//# sourceMappingURL=hints.js.map?rel=1509481879592