...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__48285__auto__,writer__48286__auto__,opt__48287__auto__){
return cljs.core._write.call(null,writer__48286__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__49440 = o;
(G__49440[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__49441__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__49441 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49442__i = 0, G__49442__a = new Array(arguments.length -  0);
while (G__49442__i < G__49442__a.length) {G__49442__a[G__49442__i] = arguments[G__49442__i + 0]; ++G__49442__i;}
  args = new cljs.core.IndexedSeq(G__49442__a,0);
} 
return G__49441__delegate.call(this,args);};
G__49441.cljs$lang$maxFixedArity = 0;
G__49441.cljs$lang$applyTo = (function (arglist__49443){
var args = cljs.core.seq(arglist__49443);
return G__49441__delegate(args);
});
G__49441.cljs$core$IFn$_invoke$arity$variadic = G__49441__delegate;
return G__49441;
})()
;
} else {
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,rendered_value,dom_value,node,temp__6757__auto__){
return (function (){
...
if(cljs.core.truth_((function (){var and__47621__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__47621__auto__){
var and__47621__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__49449 = jsprops;
(G__49449["defaultValue"] = value);

(G__49449["onChange"] = ((function (G__49449,v,value,on_change){
return (function (p1__49446_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__49446_SHARP_);
});})(G__49449,v,value,on_change))
);

(G__49449["ref"] = ((function (G__49449,v,value,on_change){
return (function (p1__49447_SHARP_){
return (this$["cljsInputElement"] = p1__49447_SHARP_);
});})(G__49449,v,value,on_change))
);
...
var vec__49456 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__49456,(0),null);
var id = cljs.core.nth.call(null,vec__49456,(1),null);
var class$ = cljs.core.nth.call(null,vec__49456,(2),null);
...
var jsprops = ({"argv": v});
var temp__6757__auto___49461 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6757__auto___49461 == null)){
} else {
var key_49462 = temp__6757__auto___49461;
(jsprops["key"] = key_49462);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__49464 = (new reagent.impl.template.NativeWrapper());
(G__49464["name"] = c);
...
var len__48849__auto___49470 = arguments.length;
var i__48850__auto___49471 = (0);
while(true){
if((i__48850__auto___49471 < len__48849__auto___49470)){
args__48856__auto__.push((arguments[i__48850__auto___49471]));

var G__49472 = (i__48850__auto___49471 + (1));
i__48850__auto___49471 = G__49472;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__48857__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq49468){
var G__49469 = cljs.core.first.call(null,seq49468);
var seq49468__$1 = cljs.core.next.call(null,seq49468);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__49469,seq49468__$1);
});
...
break;
default:
var G__49476 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__49476;
continue;
...
var n__48649__auto___49479 = a.length;
var i_49480 = (0);
while(true){
if((i_49480 < n__48649__auto___49479)){
(a[i_49480] = reagent.impl.template.as_element.call(null,(a[i_49480])));

var G__49481 = (i_49480 + (1));
i_49480 = G__49481;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__48649__auto___49482 = a.length;
var i_49483 = (0);
while(true){
if((i_49483 < n__48649__auto___49482)){
var val_49484 = (a[i_49483]);
if((cljs.core.vector_QMARK_.call(null,val_49484)) && ((reagent.impl.template.key_from_vec.call(null,val_49484) == null))){
(o["no-key"] = true);
} else {
}

(a[i_49483] = reagent.impl.template.as_element.call(null,val_49484));

var G__49485 = (i_49483 + (1));
i_49483 = G__49485;
continue;
} else {
}
...
var ctx = ({});
var vec__49489 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__49489,(0),null);
var derefed = cljs.core.nth.call(null,vec__49489,(1),null);
...
var G__49493 = (cljs.core.count.call(null,argv) - first_child);
switch (G__49493) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__49493){
...
//# sourceMappingURL=template.js.map?rel=1509481862163