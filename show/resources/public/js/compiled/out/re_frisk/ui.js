...
re_frisk.ui.frisk_style = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"backgroundColor","backgroundColor",1738438491),"#FAFAFA",new cljs.core.Keyword(null,"fontFamily","fontFamily",1493518353),"Consolas,Monaco,Courier New,monospace",new cljs.core.Keyword(null,"fontSize","fontSize",919623033),"12px",new cljs.core.Keyword(null,"height","height",1025178622),"100%",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null);
...
re_frisk.ui.ie_QMARK_ = (function (){var or__47633__auto__ = cljs.core.re_find.call(null,/MSIE /,re_frisk.ui.ua);
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
var or__47633__auto____$1 = cljs.core.re_find.call(null,/Trident\//,re_frisk.ui.ua);
...
var map__49773 = re_frisk.ui.get_client_rect.call(null,e);
...
var left = cljs.core.get.call(null,map__49773__$1,new cljs.core.Keyword(null,"left","left",-399115937));
var top = cljs.core.get.call(null,map__49773__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
...
var len__48849__auto___49778 = arguments.length;
var i__48850__auto___49779 = (0);
while(true){
if((i__48850__auto___49779 < len__48849__auto___49778)){
args__48856__auto__.push((arguments[i__48850__auto___49779]));

var G__49780 = (i__48850__auto___49779 + (1));
i__48850__auto___49779 = G__49780;
continue;
} else {
}
break;
...
return re_frisk.ui.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__48857__auto__);
});

re_frisk.ui.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic = (function (data){
var expand_by_default = cljs.core.reduce.call(null,(function (p1__49775_SHARP_,p2__49776_SHARP_){
return cljs.core.assoc_in.call(null,p1__49775_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__49776_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.fromArray([cljs.core.PersistentVector.EMPTY], true));
...
return (function() { 
var G__49781__delegate = function (data__$1){
...
var G__49781 = function (var_args){
var data__$1 = null;
if (arguments.length > 0) {
var G__49782__i = 0, G__49782__a = new Array(arguments.length -  0);
while (G__49782__i < G__49782__a.length) {G__49782__a[G__49782__i] = arguments[G__49782__i + 0]; ++G__49782__i;}
  data__$1 = new cljs.core.IndexedSeq(G__49782__a,0);
} 
return G__49781__delegate.call(this,data__$1);};
G__49781.cljs$lang$maxFixedArity = 0;
G__49781.cljs$lang$applyTo = (function (arglist__49783){
var data__$1 = cljs.core.seq(arglist__49783);
return G__49781__delegate(data__$1);
});
G__49781.cljs$core$IFn$_invoke$arity$variadic = G__49781__delegate;
return G__49781;
})()
;
;})(expand_by_default,state_atom))
...
re_frisk.ui.re_frisk_panel.cljs$lang$applyTo = (function (seq49777){
return re_frisk.ui.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49777));
});

re_frisk.ui.re_frisk_shell = (function re_frisk$ui$re_frisk_shell(data,p__49784){
var map__49787 = p__49784;
var map__49787__$1 = ((((!((map__49787 == null)))?((((map__49787.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49787.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49787):map__49787);
var on_click = cljs.core.get.call(null,map__49787__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var x = cljs.core.get.call(null,map__49787__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__49787__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var width = cljs.core.get.call(null,map__49787__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__49787__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
var height__$1 = (cljs.core.truth_((function (){var and__47621__auto__ = re_frisk.ui.ie_QMARK_;
...
return ((function (style,height__$1,style__$1,style__$2,map__49787,map__49787__$1,on_click,x,y,width,height){
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"position","position",-2011731912),"fixed",new cljs.core.Keyword(null,"left","left",-399115937),[cljs.core.str(new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.ui.draggable))),cljs.core.str("px")].join(''),new cljs.core.Keyword(null,"top","top",-1856271961),[cljs.core.str(new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.ui.draggable))),cljs.core.str("px")].join(''),new cljs.core.Keyword(null,"z-index","z-index",1892827090),(999)], null),(cljs.core.truth_((function (){var or__47633__auto__ = re_frisk.ui.ie_QMARK_;
if(cljs.core.truth_(or__47633__auto__)){
return or__47633__auto__;
} else {
...
});})(style,height__$1,style__$1,style__$2,map__49787,map__49787__$1,on_click,x,y,width,height))
...
//# sourceMappingURL=ui.js.map?rel=1509481862910